...
import { IndexVehicleTypeRoutingModule } from './index-vehicle-type-routing.module';
...
@NgModule({
  declarations: [
    IndexVehicleTypeComponent
  ],
  imports: [
      CommonModule,
      IndexVehicleTypeRoutingModule,
      FormsModule,
      ReactiveFormsModule,
...
export class IndexVehicleTypeModule { }
