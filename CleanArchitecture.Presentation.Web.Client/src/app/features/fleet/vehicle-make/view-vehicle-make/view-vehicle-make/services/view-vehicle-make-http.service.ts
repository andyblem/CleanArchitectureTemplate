...
export class ViewVehicleMakeHttpService {

  prefix: string = 'VehicleMakes';
  ...
  public update(vehicleMakeId: number, vehicleMake: IViewVehicleMakeDto): Observable<ArrayBuffer> {
