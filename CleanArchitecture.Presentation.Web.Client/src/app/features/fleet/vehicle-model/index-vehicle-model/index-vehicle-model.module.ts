...
import { IndexVehicleModelRoutingModule } from './index-vehicle-model-routing.module';
...
@NgModule({
  declarations: [
    IndexVehicleModelComponent
  ],
  imports: [
      CommonModule,
      IndexVehicleModelRoutingModule,
      FormsModule,
      ReactiveFormsModule,
...
export class IndexVehicleModelModule { }
