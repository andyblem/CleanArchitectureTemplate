...
import { IndexInvestmentTypeRoutingModule } from './index-investment-type-routing.module';
...
@NgModule({
  declarations: [
    IndexInvestmentTypeComponent
  ],
  imports: [
      CommonModule,
      IndexInvestmentTypeRoutingModule,
      FormsModule,
      ReactiveFormsModule,
...
export class IndexInvestmentTypeModule { }
