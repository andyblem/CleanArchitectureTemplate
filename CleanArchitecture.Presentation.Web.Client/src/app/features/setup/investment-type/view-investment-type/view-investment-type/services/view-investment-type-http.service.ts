...
export class ViewInvestmentTypeHttpService {

  prefix: string = 'InvestmentTypes';
  ...
  public update(vehicleMakeId: number, vehicleMake: IViewInvestmentTypeDto): Observable<ArrayBuffer> {
